...
describe('Writer', () => {
  ...
  before(async () => {
    ...
    await pool.query('CREATE TABLE IF NOT EXISTS timeouts(userid VARCHAR NOT NULL, timeout_date TIMESTAMPTZ, fulfilled BOOLEAN, PRIMARY KEY (userid, timeout_date));')
  ...
  describe('dean', () => {
    ...
    it('sends a synthetic event that matches our mock library', async () => {
      ...
      nock('http://botserver.com')
        .post('/synthetic', JSON.stringify(expect))
